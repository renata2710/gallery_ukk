...
<div class="view card card-primary card-outline">
    ...
    <div class="card-body table-responsive p-0">
        <table class="table table-hover text-nowrap">
            ...
            <tr>
                <th><?= __('Foto') ?></th>
                <td><?= $this->Html->image('/img/pengaduan/'.$pengaduan->foto,['style' => 'max-width:100px; max-height:100px;']) ?></td>
                <!-- <td><?= $this->Html->image($pengaduan->foto, ['alt' => 'foto', 'style' => 'max-width:100px; max-height:100px;']) ?></td> -->
            </tr>
            <tr>
                <th><?= __('Status') ?></th>
...
<div class="related related-tanggapan view card">
    ...
    <div class="card-body table-responsive p-0">
        <table class="table table-hover text-nowrap">
            ...
            <?php else : ?>
                <?php $i=1; foreach ($pengaduan->tanggapan as $tanggapan) : ?>
                    <tr>
