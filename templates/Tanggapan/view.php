...
<div class="view card card-primary card-outline">
    <div class="card-header d-sm-flex">
        <h2 class="card-title"><?= h($tanggapan->id_tanggapan) ?></h2>
    </div>
    <div class="card-body table-responsive p-0">
        <table class="table table-hover text-nowrap">
            ...
            <tr>
                <th><?= __('Pengaduan') ?></th>
                <td><?= $tanggapan->has('pengaduan') ? $this->Html->link($tanggapan->pengaduan->foto, ['controller' => 'Pengaduan', 'action' => 'view', $tanggapan->pengaduan->id]) : '' ?></td>
            </tr>
            <tr>
...
<div class="view text card">
    <div class="card-header">
        <h3 class="card-title"><?= __('Isi Tanggapan') ?></h3>
    </div>
    <div class="card-body">
