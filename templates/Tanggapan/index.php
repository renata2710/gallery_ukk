...
<div class="card card-primary card-outline">
    <div class="card-header d-flex flex-column flex-md-row">
        ...
        <div class="d-flex ml-auto">
            ...
            <?= $this->Html->link(('New Tanggapan'), ['action' => 'add'], ['class' => 'btn btn-primary btn-sm ml-2']) ?>
        </div>
    </div>
    <!-- /.card-header -->
            ...
            <tbody>
                <?php foreach ($tanggapan as $tanggapan) : ?>
                    <tr>
                        ...
                        <td class="actions">
                            <?= $this->Html->link(('View'), ['action' => 'view', $tanggapan->id], ['class' => 'btn btn-xs btn-outline-primary', 'escape' => false]) ?>
                            <?= $this->Html->link(('Edit'), ['action' => 'edit', $tanggapan->id], ['class' => 'btn btn-xs btn-outline-primary', 'escape' => false]) ?>
                            <?= $this->Form->postLink(('Delete'), ['action' => 'delete', $tanggapan->id], ['class' => 'btn btn-xs btn-outline-danger', 'escape' => false, 'confirm' => __('Are you sure you want to delete # {0}?', $tanggapan->id)]) ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
